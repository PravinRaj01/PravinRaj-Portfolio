...
const AVAILABLE_PAGES = [
  { id: 'home', label: 'Home', description: 'Main landing page', defaultModes: ['professional', 'creative'] },
  { id: 'projects', label: 'Projects', description: 'Projects showcase page', defaultModes: ['professional', 'creative'] },
  { id: 'experience', label: 'Experience', description: 'Work experience page', defaultModes: ['professional', 'creative'] },
  { id: 'academic', label: 'Academic', description: 'Education, certifications & achievements', defaultModes: ['professional'] },
  { id: 'contact', label: 'Contact', description: 'Contact form page', defaultModes: ['professional', 'creative'] },
  { id: 'podcast', label: 'Podcast', description: 'Podcast/media page', defaultModes: ['creative'] },
];

// Default pages per mode
const DEFAULT_PROFESSIONAL_PAGES = AVAILABLE_PAGES.filter(p => p.defaultModes.includes('professional')).map(p => p.id);
const DEFAULT_CREATIVE_PAGES = AVAILABLE_PAGES.filter(p => p.defaultModes.includes('creative')).map(p => p.id);
...
const ModeSettingsManager = () => {
  ...
  const form = useForm<ModeSettingsFormData>({
    ...
    defaultValues: {
      ...
      professional_visible_pages: settings?.professional_visible_pages ?? DEFAULT_PROFESSIONAL_PAGES,
      creative_visible_pages: settings?.creative_visible_pages ?? DEFAULT_CREATIVE_PAGES,
    },
  });
