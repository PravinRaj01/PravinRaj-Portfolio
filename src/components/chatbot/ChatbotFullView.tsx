...
import { Loader2, Send, Sparkles, Minimize2, X, Maximize2, Plus, Trash2, MessageSquare, ChevronDown, Settings2 } from "lucide-react";
          ...
          <div className="flex gap-1">
            {showModeSelector && (
              <DropdownMenu>
                ...
                >
                  <DropdownMenuLabel className="text-xs text-muted-foreground">Answer from</DropdownMenuLabel>
                  <DropdownMenuSeparator className="bg-white/10" />
                  <DropdownMenuItem 
